...
func Test_getParams(t *testing.T) {
	tests := []struct {
		...
		{
			"Valid parameters",
			inputBlueprint{"https://github.com/GenesysCloudBlueprints/angular-app-with-genesys-cloud-sdk", "./default_rule.json"},
			false,
			[]string{"cmd", "https://github.com/GenesysCloudBlueprints/angular-app-with-genesys-cloud-sdk", "./default_rule.json"},
		},
		{"No parameters", inputBlueprint{}, true, []string{"cmd"}},
		{
